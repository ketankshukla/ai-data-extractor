...
[![CI](https://github.com/ketankshukla/ai-data-extractor/actions/workflows/ci.yml/badge.svg)](https://github.com/ketankshukla/ai-data-extractor/actions/workflows/ci.yml)
[![License: MIT](https://img.shields.io/badge/license-MIT-yellow.svg)](./LICENSE)
[![Deployed on Vercel](https://img.shields.io/badge/deployed-vercel-black.svg)](https://ai-data-extractor-seven.vercel.app/)
...
> 🧠 Curious about the *actual reasoning* behind every one of those steps — including the snags hit and how they were fixed? Read **[THOUGHT_PROCESS.md](./THOUGHT_PROCESS.md)**.
